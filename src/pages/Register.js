                ...
                <div className="mt-10 flex flex-col items-center w-[100%] sm:w-2/5">
                    ...
                    <div className="mt-5 md:w-96 w-[90%] relative">
                        <div className="md:flex gap-5 items-center mb-2">                            
                            <Input labelValue="First name" inputType="text" hint="Enter First name" />
                            <Input labelValue="Last name" inputType="text" hint="Enter Last name" />
                        </div>
                        ...
                        <Button value="Sign up" className="flex justify-center md:w-auto" icon={<BsArrowRight />}  />
                    </div>
